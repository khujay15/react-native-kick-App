      ...
      >
        <ScrollView style={{ marginHorizontal: 30 }}>
          ...
          <FoldableView title="왜 면허가 필요한가요?">
            <View style={{ marginVertical: 10 }}>
              <Text>
                ...
                동력으로 하는 경우에는 정격출력 0.59kW 미만)의 원동기를 단 차’는
                모두 원동기 장치자전거이며,원동기장치 자전거를 운전하기
                위해서는ㅍ운전면허가 필요합니다. 만16세부터 취득할 수 있는 2종
                원동기장치자전거 면허, 또는 그 밖의 1·2종 운전면허를 취득한 경우
                운전이 가능합니다.
              </Text>
            </View>
          </FoldableView>
          ...
          <FoldableView title="인도에서 주행해도 괜찮을까요">
            <View style={{ marginVertical: 10 }}>
              <Text>
                전동킥보드는 오토바이와 같은 법적 지위를 가지고 있기에 차도에서
                주행하여야 합니다. 도로교통법 제 20조(진로 양보의 의무)에 따라
                차도의 우측 가장자리를 이용해 다른 차의 진로를 양보하며
                주행하여야 합니다.
              </Text>
            </View>
          </FoldableView>
